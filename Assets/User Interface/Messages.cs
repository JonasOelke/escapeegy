...
public class Messages : MonoBehaviour
{
    ...
    public ChatMessage[] GetChatMessages()
    {
        ...
        // We forgot message 4 ... now we have an empty one
        ...
        ChatResponse message7Response = new ChatResponse("Schick mir ein Bild davon!", "");
        ...
        ChatResponse message11Response = new ChatResponse("Das weiß ich nicht", "");
        ...
        ChatResponse message16Response = new ChatResponse("Sind die “versprochen??", "");
        ...
        //---------------StechUhr Messages
        ChatResponse message20Response = new ChatResponse("Leg es übereinander", "");
        ...
        ChatResponse message30Response = new ChatResponse("Das war damals einfach so... ", "");
        ...
        ChatResponse message32Response = new ChatResponse("schau dich mal um", "");
        ...
        ChatResponse message36Response2 = new ChatResponse("Wie geht es dir?", "");
        ...
        ChatResponse message40Response2 = new ChatResponse("", "Tagebucheintrag26.Dezember");
        ...
        ChatResponse message44Response = new ChatResponse("Was soll man dazu noch sagen...", "");
        ...
        //Vorher Bild senden
        ChatResponse message52Response = new ChatResponse("War so üblich damals", "");
        ...
        ChatResponse message56Response2 = new ChatResponse("Das ist wohl dieser Fiete… ", "");
        ...
        ChatResponse[] chatResponseArray =
        {
            message8Response,
            message10Response,
            message44Response
    ...
    public ChatResponse[] GetChatResponses()
    {
        ...
        //Vorher Bild von allen Schnipseln senden
        ChatResponse message56Response = new ChatResponse("Das ist wohl dieser Fiete… ", "");
