...
public class Messages : MonoBehaviour
{
    ...
    ChatMessage[] getChatMessages(){
        ...
        ChatResponse startMessageResponse1 = new ChatResponse("Hey du, schön von dir zu hören! Ich schau mal kurz.");
        ChatResponse startMessageResponse2 = new ChatResponse("Ich habe diese Todesanzeige gefunden und einen Tagebucheintrag von einer Lieselotte");
        ...
        // Second Message
        ChatResponse message2Response = new ChatResponse("Ich glaube Lieselotte meint das Insititut für Geburtshilfe in Uhlenhorst, zumindest geht das aus ihren anderen Tagebucheinträgen hervor. Ich weiß nicht wer Fiete ist, vielleicht finde ich noch was dazu.");
        ChatMessage message2 = new ChatMessage(
         ...
         // Third Message
        ChatResponse message3Response = new ChatResponse("Ja, klar. Vielleicht gibt es da eine/n <ersten Startpunkt> einfügen.")
